  ...
  if(!chart2) {
    chart2 = new Chart(ctx2, {
      ...
      options: {
        title: {
          display: true,
          text: '¿Qué temas te interesa trabajar mediante ciencia y tecnología?',
          fontSize: '30'
        }
      }
    });
...
function getStat() {
  ...
  var uri2 = encodeURI(SERVER + 'get-stat?data=temas-interes&programa=' + filter.programa + '&escuela=' + filter.escuela + '&sexo=' + filter.sexo + '&edad-min=' + filter.edadMin + '&edad-max=' + filter.edadMax);
