...
function getStat() {
  ...
  var uri = encodeURI(SERVER + 'get-stat?data=admiracion&programa=' + filter.programa + '&escuela=' + filter.escuela + '&sexo=' + filter.sexo + '&edad-min=' + filter.edadMin + '&edad-max=' + filter.edadMax);
